function  [T_otsu, current_all_matching_bw, current_model ]  = bn_geoBasedNmsSeg_withGM(imageNMS, imageInt, classifier_trained, graph_matching_flag,MaskCell,iFrame,FilamentSegmentationChannelOutputDir,funParams,iChannel)
...
if(isfield(funParams, 'noGraphics') && funParams.noGraphics == 1)
    doGraphics = false;
else
    doGraphics = true;
end
...
if(graph_matching_flag==1)
    ...
    [current_model,current_matching_bw,model_ind,transformer, final_set_rescue, final_set_connection, connect_count,bw_rgb_three_color,bw_whitergb_three_color]...
        = bn_graph_matching_linking_once([], current_all_seg_bw, confidency_interval,imageInt, ...
    ...
    if(IternationNumber>1)
        ...
        iIteration=1;
        [current_model,current_matching_bw, model_ind,transformer,final_set_rescue, final_set_connection, connect_count,bw_rgb_three_color,bw_whitergb_three_color]...
            = bn_graph_matching_linking_once(current_model, current_all_seg_bw, confidency_interval,imageInt, ...
    ...
    if(IternationNumber>2)
        for iIteration = 2 : IternationNumber
            bn_graph_matching_iteration_in_segmentation;
        end
    end
