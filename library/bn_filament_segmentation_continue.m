function movieData = bn_filament_segmentation_continue(movieData, paramsIn, wholemovie_input_filename, varargin)
...
% Add noGraphics field to the paramsIn structure. 
    ...
    for iFrame_index = 1 : length(Frames_to_Seg)
        ...
        switch Combine_Way
            ...
            case 'reserved_for_test'
                ...
                TIC_geoBased_GM = tic;
                [level2, NMS_Segment,current_model ] = ...
                    bn_geoBasedNmsSeg_withGM(nms,currentImg, F_classifer_train_this_channel,1,...
